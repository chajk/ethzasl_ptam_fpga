...
#include <tf/transform_datatypes.h>
#include <cmath>
>>>>>>> bcd9be3cfb6ea676ee2e29364efd6540e674b98f
...
int main(int argc, char* argv[])
{
   ...
   logo_faces = LoadOBJ_for_KETILOGO("/home/rodong/Work/catkin_ws/devel/lib/opengl_ros/KETI_LOGO.obj", 
=======
       //cout << "cnt: " << cnt << endl;
    }
...
<<<<<<< HEAD
   spell_faces = LoadOBJ_for_KETILOGO( "/home/rodong/Work/catkin_ws/devel/lib/opengl_ros/KETI_SPELL.obj", 
=======
   ...
   */
   ...
   { //Third Object ==> targetObject KETI
      if (mapQuality == 1 && drawObject == true)
      {
         ...
         glPushMatrix();
         //glTranslatef(0.0f, 0.0f, 0.0f);
         glTranslatef(_trans_x, _trans_y, 0.0f); // Object Translate
   ...
   { //Forth Object ==> Background cvRender 
      ...
      //glTranslatef(-_trans_x, -_trans_y, -5.0f);
